...
// The more of these puzzles you solve, the more patterns you'll see. 
// It'll take time and focus to develop the deductive reasoning to use old 
// patterns you've seen to solve new problems.
...
// If that command logs `undefined`, it's likely because the function isn't returning anything. 
// Make sure your function is returning something!

// That something will likely get defined before a for loop and returned after.

// Making sure you've done step 1 correctly (understanding the problem) will save
// you heartache in any code challenge problem-solving.